...
fun LazyGridScrollbar(
  ...
  LazyGridScrollbar(
    gridState = scrollbarCustomization.state as LazyGridState,
    columns = columns,
...
/**
 * Scrollbar for LazyGrid
 * Use this variation if you want to place the scrollbar independently of the LazyGrid position
 *
 * @param rightSide true -> right,  false -> left
 * @param thickness Thickness of the scrollbar thumb
 * @param padding Padding of the scrollbar
