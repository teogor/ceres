...
import dev.teogor.ceres.ui.spectrum.util.ColorUtils.whitePointD65
import dev.teogor.ceres.ui.spectrum.util.ColorUtils.yFromLstar
import dev.teogor.ceres.ui.spectrum.util.MathUtils.clampDouble
import dev.teogor.ceres.ui.spectrum.util.MathUtils.lerp
...
private constructor(
  ...
  companion object {
    ...
    val DEFAULT = make(
      ...
      200.0 / Math.PI * yFromLstar(50.0) / 100f,
      50.0,
      2.0,
      false,
    )
     ...
     * like watching a movie in a theater. 1.0 is a dimly light room, like watching TV at home
     * at night. 2.0 means there is no difference between the lighting on the color and around
     * it. default = 2.0
    ...
    fun make(
      ...
      val c =
        if (f >= 0.9) lerp(0.59, 0.69, (f - 0.9) * 10.0) else lerp(0.525, 0.59, (f - 0.8) * 10.0)
      var d =
