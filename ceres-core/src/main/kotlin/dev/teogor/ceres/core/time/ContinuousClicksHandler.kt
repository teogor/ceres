...
package dev.teogor.ceres.core.time
...
class ContinuousClicksHandler(
  ...
  private val timeWatcher = TimeWatcher(maxInterval)
  ...
  fun registerCallback(callback: ContinuousClicksCallback): ContinuousClicksHandler {
