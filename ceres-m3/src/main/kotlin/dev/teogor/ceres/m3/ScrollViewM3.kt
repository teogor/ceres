    ...
    context.theme.obtainStyledAttributes(
      ...
      try {
        backgroundColorM3 = ColorM3.values()[
          getInt(
            R.styleable.ScrollViewM3_background_m3,
            0
          )
        ]
        backgroundTintColorM3 = ColorM3.values()[
          getInt(
            R.styleable.ScrollViewM3_background_m3_tint_overlay,
            0
          )
        ]
        backgroundTintOverlay = getFloat(R.styleable.ScrollViewM3_background_m3_tint, 0f)
      } finally {
        recycle()
      }
    }
