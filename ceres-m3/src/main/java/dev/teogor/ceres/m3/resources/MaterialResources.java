...
public class MaterialResources {
   ...
   *
   * <p>You only need this if you are drawing text manually. Normally, TextView takes care of
   * this.
   */
  @Nullable
   ...
   *
   * <p>If the text size from the text appearance is using dp, the density scaled value will be
   ...
   *
   * <p>This is used for components that do not scale their text due to being space constrained
