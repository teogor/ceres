...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
   ...
   * certain features, such as swipe-to-dismiss and automatically moving of widgets.
   *
  ...
  private static Snackbar makeInternal(
    ...
    final SnackbarContentLayout content =
      (SnackbarContentLayout)
        inflater.inflate(R.layout.lm3_snackbar_include, parent, false);
   ...
   * snackbarButtonStyle}. This method helps to check if a valid {@code snackbarButtonStyle} is
   * set within the current context, so that we know whether we can use the attribute.
   *
